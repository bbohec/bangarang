...
const components = [
	{
		js: () => Promise.all([import('./index.b8f03c15.js'), __inject_styles(["client-69490a83.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersAgileTeamMember.9160de57.js'), __inject_styles(["client-69490a83.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersSyndicalist.54748d98.js'), __inject_styles(["client-69490a83.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersActivist.269363d0.js'), __inject_styles(["client-69490a83.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./BusinessModel.62dbdfd8.js'), __inject_styles(["client-69490a83.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./LeanCanvas.82f5e77c.js'), __inject_styles(["client-69490a83.css"])]).then(function(x) { return x[0]; })
	}
];
