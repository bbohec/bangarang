...
const components = [
	{
		js: () => Promise.all([import('./index.89f68b7d.js'), __inject_styles(["index-69490a83.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersAgileTeamMember.404fd005.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersSyndicalist.261cf7e3.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersActivist.62d3b277.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./BusinessModel.96f11591.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./LeanCanvas.0eb3798a.js'), ]).then(function(x) { return x[0]; })
	}
];
