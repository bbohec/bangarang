...
const components = [
	{
		js: () => Promise.all([import('./index.b47fd823.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersAgileTeamMember.f2db977f.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersSyndicalist.4b1b56f2.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersActivist.9185453e.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./BusinessModel.ca33ad8d.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./LeanCanvas.3333c003.js'), ]).then(function(x) { return x[0]; })
	}
];
