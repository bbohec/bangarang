...
const components = [
	{
		js: () => Promise.all([import('./index.a8962dd8.js'), __inject_styles(["index-69490a83.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersAgileTeamMember.85af422d.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersSyndicalist.82fb7ed9.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersActivist.d14f40aa.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./BusinessModel.799ab1c3.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./LeanCanvas.f1f0402e.js'), ]).then(function(x) { return x[0]; })
	}
];
