...
const components = [
	{
		js: () => Promise.all([import('./index.cf046dad.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersAgileTeamMember.2d38109d.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersSyndicalist.ef2527fc.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./EarlyAdoptersActivist.48963663.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./BusinessModel.6a3ccd4e.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./aaaa_layout.e7706eb5.js'), __inject_styles(["aaaa_layout-69490a83.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./LeanCanvas.b022b0be.js'), ]).then(function(x) { return x[0]; })
	}
];
