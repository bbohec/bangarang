...
export const unexpectedErrorRegisteringUserNotification= (error:Error):RegisteringUserNotificationContract  => ({status:"Failed", message:{en:`Unexpected error: ${error.message}`,fr:`Erreur inatendue: ${error.message}`},type:"Registering."})
